...
margin: 5px 0 0;
padding: 15px 25px;
border: 1px solid var(--pf-bg);
border-radius: 12px;
box-shadow: 0 0 3px 1px var(--pf-accent);
...
height: 1px;
margin: 10px 0;
border: solid var(--pf-accent);
border-width: 1px 0 0 0;
box-shadow: 0 0 3px var(--pf-accent);
}
.pfRoot .partTitle {
font-size: 23px;
line-height: 45px;
...
<div class="pfRoot">
    <div class="part">
        ...
        <div class="parting"></div>
            <p>I'm a student.</p>
            <p>As of the last update of this README, I was still a juvenile in China</p>
    </div>
</div>
